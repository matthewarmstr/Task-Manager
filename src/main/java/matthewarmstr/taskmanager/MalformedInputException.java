    ...
    public MalformedInputException(String thrownMessage) {
        message = thrownMessage + """
            Commands:
              ...
              describe <task name> <description> [{S|M|L|XL}]   | "Add a description to a task (can be a new or existing task). A size (S, M, L, or XL) can be optionally assigned to this task."
